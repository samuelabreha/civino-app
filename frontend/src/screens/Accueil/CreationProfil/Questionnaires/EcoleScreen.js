...
const EcoleScreen = ({ navigation, route }) => {
  ...
  const questions = [
    {
      id: 1,
      question: "Comment te sens-tu à l'école ?",
      options: ["Très bien", "Bien", "Moyen", "Pas bien", "Très mal"],
    },
    {
      id: 2,
      question: "Aimes-tu participer en classe ?",
      options: ["Beaucoup", "Un peu", "Pas du tout"],
    },
    {
      id: 3,
      question: "As-tu des amis à l'école ?",
      options: ["Beaucoup", "Quelques-uns", "Aucun"],
    },
    {
      id: 4,
      question: "Comment trouves-tu les devoirs ?",
      options: ["Faciles", "Normaux", "Difficiles"],
    },
  ];
  ...
  const handleNext = () => {
    navigation.navigate('MaisonDeQuartier', {
      statut,
      nom,
      prenom,
      contrats,
  ...
  return (
    <View style={styles.container}>
      <Header title="Questionnaire École" />
